...
public class testAuto extends SequentialCommandGroup{
    ...
    public testAuto(DriveSubsystem driveSubsystem, ShootSubsystem shooter, IntakeSubsystem intake){
        ...
        Pose2d revPose = new Pose2d(1.5, 0, new Rotation2d(0));
        Translation2d revTrans = new Translation2d(1, 0);
        Translation2d revTransTwo = new Translation2d(0.5, 0);
        Pose2d revPoseTwo2d = new Pose2d(0, 0, new Rotation2d(0));
        addCommands(
